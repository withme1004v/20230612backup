...
})()(
  {
    ...
    54: [
      function (require, module, exports) {
        "use strict";
        var app,
          initSGI = require("./AppMeasurement/initialize"),
    ...
    58: [
      function (require, module, exports) {
        ...
        } = require("./element-engagement-observer/ElementEngagementObserver");
        module.exports = {
                    ...
                    if (
                      (n ||
                        errorHandler.log(
                          moduleName,
                          "bucket",
                          "analytics-s-bucket-" + a + " metadata tag must exist"
                        ),
                      !errorHandler.exception)
                    ) {
    ...
    72: [
      function (require, module, exports) {
        "use strict";
        var plugins = [
          require("./appMeasurementPlugins/AppMeasurementTools"),
          require("./appMeasurementPlugins/utilities/utilities"),
          require("./appMeasurementPlugins/linkHandler"),
          require("./appMeasurementPlugins/getPercentPageViewed"),
          require("./appMeasurementPlugins/getQueryParam"),
          require("./appMeasurementPlugins/getValOnce"),
          require("./appMeasurementPlugins/activitymap/link"),
          require("./appMeasurementPlugins/activitymap/region"),
          require("./appMeasurementPlugins/activitymap/ActivityMapCollection"),
        ];
    ...
    84: [
      function (require, module, exports) {
        ...
        doPluginsRegistry.pretracking.main.steps.push(
          require("./plugins/referrerQueryParam")
        ),
          doPluginsRegistry.tracking.sideEffects.steps.push(
            require("./plugins/handleLink"),
            require("./plugins/specialRssLinks")
          ),
          doPluginsRegistry.tracking.main.steps.push(
            trackingState.begin,
            require("./plugins/acAnalyticsVersion"),
            require("./plugins/externalCampaign"),
            require("./plugins/internalCampaign"),
            require("./plugins/percentPageViewed"),
            require("./plugins/afid"),
            require("./plugins/retailCookies"),
            require("./plugins/feedbackPage"),
            require("./plugins/contactRetail"),
            require("./plugins/asTex"),
            require("./plugins/enhanceDownloadLinks"),
            require("./plugins/langLocale"),
            require("./plugins/userSignInStatus"),
            require("./plugins/pageName"),
            require("./plugins/asPvi"),
            require("./plugins/hierarchy1"),
            require("./plugins/referrerAndCurrentUrl"),
            require("./plugins/clickTimer"),
            require("./plugins/beaconType"),
            require("./plugins/linkMissingTitle")
          ),
          doPluginsRegistry.tracking.finalize.steps.push(
            require("./plugins/passiveTracker"),
            require("./plugins/newPassiveTracker")
          ),
          doPluginsRegistry.tracking.sanitize.steps.push(
            require("./plugins/removeSpacesInLinkTrackVars"),
            require("./plugins/manageVars")
          ),
          doPluginsRegistry.cleanup.main.steps.push(
            require("./plugins/clearLinkTracksAfterDownloadAndExit")
          ),
          doPluginsRegistry.cleanup.finalize.steps.push(
            trackingState.end,
            require("./plugins/setTcallToFalse")
          ),
    ...
    155: [
      function (require, module, exports) {
        ...
        var Tracker = require("../Tracker"),
          ...
          onDocumentReady = require("../helpers/onDocumentReady"),
          dynamicEventBinder =
            require("../helpers/dynamicEventBinder").dynamicEventBinder,
          dynamicEventBinderRemoveListeners =
            require("../helpers/dynamicEventBinder").removeListeners,
          EventEmitterMicro =
            require("@marcom/ac-event-emitter-micro").EventEmitterMicro,
          isIntraPageLink = require("../helpers/DOM").isIntraPageLink,
              ...
              },
              {
                ...
                value: function () {
                  [
                    ...
                    require("./endOfPage"),
                    require("./pageLoad"),
                    require("./storeDeferredBeaconAtPageLoad"),
                    require("./customPageLoad"),
                    require("./deferredToPageLoad"),
                    require("./sectionEngagement"),
                    require("./click"),
                    require("./link"),
                    require("./navigationalLink"),
                    require("./gallery"),
                    require("./video"),
                    require("./event"),
                    require("./elementEngagement"),
                    require("./performance"),
                    require("./search/begin"),
                    require("./search/perform"),
                  ].forEach(function (e) {
                    e.initialize();
                  });
                },
    ...
    172: [
      function (require, module, exports) {
        ...
        var registry = require("./TrackerRegistry"),
          passiveTracker = require("../passiveTracker"),
          performanceTimingEvents =
            require("../constants").performanceTimingEvents,
    ...
    "@marcom/ac-analytics": [
      function (require, module, exports) {
        ...
        module.exports = {
          ...
          resetActivityMap:
            require("./ac-analytics/Appmeasurement/appMeasurementPlugins/activitymap/ActivityMapCollection")
          ...
          trackFirstMeaningfulPaint:
            require("./ac-analytics/trackers/performance")
              .trackFirstMeaningfulPaint,
          dataLayer: {
            get: _get,
            set: set,
