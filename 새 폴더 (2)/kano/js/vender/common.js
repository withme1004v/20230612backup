...
$(document).ready(function  () {
	...
	* Func : 상단 :: 모바일 gnb 스크롤
	************************ */
	if ($.exists('.gnb-navigation-inner')) {
		 customScrollY ($(".gnb-navigation-inner"));
	}
	...
	************************ */
	if ($.exists('.sitemap-open-btn')) {
		...
		$(".sitemap-news-list").slick({
			...
			pauseOnHover:false,
			zIndex:1,
			appendArrows:$("#sitemapContent .arrow-box"),
